...
public class JdbcAuthorRepositoryTest {
    ...
    void shouldSaveNewAuthor() {
        var expectedAuthor = new Author(0, "Author_5000");
        var returnedAuthor = repositoryJdbc.insert(expectedAuthor);
    ...
    void shouldSaveUpdatedAuthor() {
        var expectedAuthor = new Author(1L, "Author_5000");
        ...
        var returnedAuthor = repositoryJdbc.update(expectedAuthor);
